...
abstract class PageScraper<in P, out R> {

    abstract fun scrape(credentials: Credentials, params: P): R

    protected class SiakHttpClient(private val credentials: Credentials) {
        ...
        fun httpGet(url: String): BilingualResponse {
            ...
            return if (isRedirectedToAuthenticationPage(bilingualResponse.responseInd) || isRedirectedToAuthenticationPage(bilingualResponse.responseEng)) {
                authenticate()
